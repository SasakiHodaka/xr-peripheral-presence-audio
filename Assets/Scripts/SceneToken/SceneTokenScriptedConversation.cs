...
namespace SceneTokens
{
    public class SceneTokenScriptedConversation : MonoBehaviour
    {
        ...
        public bool autoStartWithExperimentSession;
        ...
        public ScriptedUtterance[] utterances =
        {
            ...
            new ScriptedUtterance
            {
                ...
                urgency = SceneUrgency.LOW,
                targetObjectId = "Pump3",
                utteranceText = "Yes, that part looks aligned.",
                semanticConfidence = 0.95f
            },
            new ScriptedUtterance
            {
                ...
                urgency = SceneUrgency.HIGH,
                targetObjectId = "Valve2",
                utteranceText = "Move this object forward, please.",
            ...
            new ScriptedUtterance
            {
                ...
                urgency = SceneUrgency.CRITICAL,
                targetObjectId = "Pump3",
                utteranceText = "Be careful, the direction is wrong.",
                semanticConfidence = 0.9f
            },
            new ScriptedUtterance
            {
                ...
                urgency = SceneUrgency.LOW,
                targetObjectId = "Valve2",
                utteranceText = "I think that direction is good.",
        ...
        private void Awake()
        {
            ...
            if (experimentSession != null && experimentSession.scriptedConversation == null)
            {
                experimentSession.scriptedConversation = this;
            }
        ...
        private void UpdateExperimentSessionState()
        {
            ...
            var shouldFollowExperiment = autoStartWithExperimentSession ||
                experimentSession.startScriptedConversationWithTrial;

            if (!shouldFollowExperiment)
            {
                return;
            }

            if (experimentSession.IsRunning && (!wasExperimentRunning || !isRunning))
            {
                StartScript();
            }
        ...
        private void ApplyUtterance(ScriptedUtterance utterance, bool[] activeSpeakers)
        {
            ...
            speaker.urgency = utterance.urgency;
            speaker.targetObjectId = utterance.targetObjectId;
            speaker.utteranceText = utterance.utteranceText;
            speaker.semanticConfidence = utterance.semanticConfidence;
            if (utterance.audioClip != null)
            {
                speaker.speakingClip = utterance.audioClip;
            }
