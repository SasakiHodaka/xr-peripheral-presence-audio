...
def print_summary(by_condition):
    print(
        "condition,events,sessions,participants,trials,eventTypes,directionResponses,speakerResponses,directionAccuracyPct,speakerAccuracyPct,directionLatencySec,speakerLatencySec,ambiguousResponses"
    )
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python Tools/analyze_event_logs.py <scene_token_events_csv_or_directory>")
        return 1
